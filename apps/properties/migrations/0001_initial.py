    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_code', models.CharField(blank=True, max_length=225, unique=True, verbose_name='Property Reference Code')),
                ('desription', models.TextField(default='Description', verbose_name='description')),
                ...
                ('street_address', models.CharField(default='KG8 Avenue', max_length=150, verbose_name='Address')),
                ...
                ('floors', models.IntegerField(default=0, verbose_name='Number of floors')),
                ...
                ('photo_1', models.ImageField(blank=True, default='/interior_sample.jpg', null=True, upload_to='')),
                ('photo_2', models.ImageField(blank=True, default='/interior_sample.jpg', null=True, upload_to='')),
                ('photo_3', models.ImageField(blank=True, default='/interior_sample.jpg', null=True, upload_to='')),
                ('photo_4', models.ImageField(blank=True, default='/interior_sample.jpg', null=True, upload_to='')),
